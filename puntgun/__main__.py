...
@click.option(
    "--settings",
    default=str(config.settings_file),
    show_default=True,
...
@click.option(
    "--secrets",
    "_secrets",
    default=str(config.secrets_file),
    show_default=True,
...
@click.option(
    "--private-key",
    default=str(config.pri_key_file),
    show_default=True,
...
@click.option(
    "-o",
    "--output",
    default=str(config.config_path.joinpath(".secrets_plaintext.yml")),
    show_default=True,
...
@gen.command(context_settings=CONTEXT_SETTINGS)
@click.option(
    "-o", "--output-path", default=str(config.config_path), show_default=True, help="Path of generated files."
)
...
@click.option(
    ...
    "--plan",
    "_plan",
    default=str(conf.config.plan_file),
    show_default=True,
